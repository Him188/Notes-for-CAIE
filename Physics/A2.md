...
39. State what is meant by work function energy \[1\]
...
45. Explain how the line spectrum of hydrogen provides evidence for the existence of discrete electron energy levels in atoms. \[3\]
46. State what is meant by the `binding energy` of a nucleus \[2\]
47. State what is meant by `nuclear fission` \[2\]
48. State what is meant by `decay constant` \[2\]
49. Define the `decay constant` of a radioactive isotope \[2\]
...
- Minimum energy to remove an electron from the metal

### State what is meant by a `photon` \[2\]
- discrete amount of energy
- electromagnetism mentioned
